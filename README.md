...
зомби процесс - дочерний процесс, который уже завершился, но родительский об этом еще не знает (не вызывал фунцию wait()), когда их мало то никаких проблем нет, но если их 1000 илл около того, то может быть проблема с появление новых процессов, так как буфер занят, чиниться командой
